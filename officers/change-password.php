...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		$sql = mysqli_query($con, "SELECT password FROM  officers where password='" . md5($_POST['password']) . "' && userEmail='" . $_SESSION['alogin'] . "'");
		$num = mysqli_fetch_array($sql);
		if ($num > 0) {
			$con = mysqli_query($con, "update officers set password='" . md5($_POST['newpassword']) . "' where username='" . $_SESSION['alogin'] . "'");
