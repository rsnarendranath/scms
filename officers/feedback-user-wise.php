        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">User Wise Feedback List</div>
...
<tbody>
<?php 
$query=mysqli_query($con,"select userEmail,feedbackValue  AS MOST_FREQUENT from feedback GROUP BY feedbackValue ORDER BY COUNT(feedbackValue) DESC LIMIT 1");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>  
