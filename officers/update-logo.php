...
move_uploaded_file($_FILES["image"]["tmp_name"],"../images/logo/".$imgnewfile);
// Query for insertion data into database
$query=mysqli_query($con,"update genaralsetting set setting_description='$imgnewfile' where id=4");
if($query)
{
