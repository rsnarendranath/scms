...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"UPDATE announcement SET discription='$description',startdate='$startdate',nodays='$nodays',expire='$expire',status='$status' WHERE id=2");
	if($status == 1)
	{
				...
				<div class="row">
                    ...
                    <?php if($errormsg)
                     ...
                     <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
									...
									<div class="form-group">
												...
												<div class="col-sm-8">
													<?php
							$query=mysqli_query($con,"SELECT discription from announcement where id=2");
							while($row=mysqli_fetch_array($query))
							{
						?>	
					...
					<?php } ?>	
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<?php 
													$query=mysqli_query($con,"SELECT status FROM announcement where id=2");
					                     			while($row=mysqli_fetch_array($query)) 
