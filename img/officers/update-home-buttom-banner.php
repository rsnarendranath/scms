...
move_uploaded_file($_FILES["image"]["tmp_name"],"../images/buttom/".$imgnewfile);
// Query for insertion data into database
$query=mysqli_query($con,"update genaralsetting set setting_description='$imgnewfile' where id=7");
if($query)
{
$successmsg="Home Bottom Picture Updated!!";
}
else
{
$errormsg="Error !! Home Bottom Picture Not Updated !!";
}
}
}
}
...
if($btmbanner==""):
?>
<img src="../images/buttom/noimage.jpg" width="330" height="120" >
<?php else:?>
	<img src="../images/buttom/<?php echo htmlentities($btmbanner);?>" width="330" height="120" >
