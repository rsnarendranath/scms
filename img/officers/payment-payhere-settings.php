...
$sql=mysqli_query($con,"update paymentsetting set secret_key = '$securityKey',site_key = '$siteKey'");
$_SESSION['msg']="Payhere Settings Updated";
...
<p style="color: green;">For Setup payhere payment settings.you will first need a PayHere Merchant account. You can create a sandbox account <a href="https://sandbox.payhere.lk/account/signup/createaccount" target="_blank">here.</a></p>
					                     	<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<input type="text" placeholder="Enter Merchant ID" value="<?php echo htmlentities($row['site_key']);?>" name="siteKey" class="form-control" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" placeholder="Enter Merchant Secret" value="<?php echo htmlentities($row['secret_key']);?>" name="securityKey" class="form-control" required>
												</div><?php } ?>
											</div>
											<div class="hr-dashed"></div>
