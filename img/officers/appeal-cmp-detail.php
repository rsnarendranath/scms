...
<?php $st='closed';
$query=mysqli_query($con,"select tblcomplaints.*,complaintstype.complaintType as cmptype,state.stateName as state,users.fullName as name,category.categoryName as catname from tblcomplaints join users on users.id=tblcomplaints.userId join category on category.id=tblcomplaints.category join state on state.id = tblcomplaints.state join complaintstype on complaintstype.id=tblcomplaints.complaintType where tblcomplaints.complaintNumber='".$_GET['id']."'");
while($row=mysqli_fetch_array($query))
{
...
<?php $ret=mysqli_query($con,"select complaintremark.remark as remark,complaintremark.status as sstatus,complaintremark.remarkDate as rdate from complaintremark join tblcomplaints on tblcomplaints.complaintNumber=complaintremark.complaintNumber where complaintremark.complaintNumber='".$_GET['id']."'");
