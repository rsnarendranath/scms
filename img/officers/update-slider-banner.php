...
move_uploaded_file($_FILES["image"]["tmp_name"],"../images/banner/".$imgnewfile);
move_uploaded_file($_FILES["image2"]["tmp_name"],"../images/banner/".$imgnewfile2);
// Query for insertion data into database
$query=mysqli_query($con,"update genaralsetting set setting_description='$imgnewfile' where id=5");
$query=mysqli_query($con,"update genaralsetting set setting_description='$imgnewfile2' where id=6");
if($query)
{
...
if($banner==""):
?>
<img src="../images/banner/logo.png" width="330" height="120" >
<?php else:?>
	<img src="../images/banner/<?php echo htmlentities($banner);?>" width="330" height="120" >
