			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Paid Not Process Appeal Complaint</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Paid Not Process Appeal List</div>
...
$query=mysqli_query($con,"select appealcomplaint.*,users.fullName,province.provinceName from appealcomplaint INNER JOIN users on users.id=appealcomplaint.UserID INNER JOIN province on province.id=appealcomplaint.province WHERE appealcomplaint.status='$status' AND appealcomplaint.paymentStatus=1");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>	
