...
if (isset($_POST['submit'])) {
	$ret = mysqli_query($bd, "SELECT * FROM officers WHERE userEmail='" . $_POST['username'] . "' and password='" . md5($_POST['password']) . "'");
...
if (isset($_POST['change'])) {
	...
	$query = mysqli_query($bd, "SELECT * FROM officers WHERE userEmail='$email' and contactNo='$contact'");
	$num = mysqli_fetch_array($query);
	if ($num > 0) {
		mysqli_query($bd, "update officers set password='$password' WHERE userEmail='$email' and contactNo='$contact' ");
