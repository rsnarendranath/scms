...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($bd, "insert into tblcomplaints(userId,category,complaintType,noc,complaintDetails,complaintFile) values('$uid','$category','$complaintype','$noc','$complaintdetials','$compfile')");
